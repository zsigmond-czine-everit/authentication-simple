...
public final class CredentialEncryptorConstants {

    public static final String COMPONENT_NAME = "org.everit.osgi.authentication.simple.core.CredentialEncryptor";

    public static final String PROP_ALGORITHM = "algorithm";

    public static final String DEF_ALGORITHM = "SHA-1";

    private CredentialEncryptorConstants() {
    }
